                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <ul class="list-inline mb-4">
                                <li class="list-inline-item d-block border-bottom me-0"><a href="{{route('account-information')}}" class="pt-2 pb-2 d-flex align-items-center"><i class="btn-round-md bg-primary-gradiant text-white feather-home font-md me-3"></i> <h4 class="fw-600 font-xsss mb-0 mt-0">Acount Information</h4><i class="ti-angle-right font-xsss text-grey-500 ms-auto mt-3"></i></a></li>
                            ...
                            <ul class="list-inline">
                                ...
                                <li class="list-inline-item d-block me-0">
                                    <form method="POST" action="{{route('auth.logout')}}" class="d-flex align-items-center">
                                        @csrf
                                        <button class="pt-2 pb-2 w-100 border-0 bg-transparent d-flex align-items-center">
                                            <i class="btn-round-md bg-red-gradiant text-white feather-lock font-md me-3"></i>
                                            <h4 class="fw-600 font-xsss mb-0 mt-0">Logout</h4>
                                        </button>
                                            <i class="ti-angle-right font-xsss text-grey-500 ms-auto"></i>
                                    </form>
                                </li>
                            </ul>
                        </div>
