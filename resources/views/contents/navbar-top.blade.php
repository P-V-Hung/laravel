...
<div class="nav-header bg-white shadow-xs border-0">
    ...
    <form action="{{route('friend-search')}}" method="GET" class="float-left header-search">
        <div class="form-group mb-0 icon-input">
            <i class="feather-search font-sm text-grey-400"></i>
            <input type="text" name="keywords" placeholder="Tìm kiếm bạn bè..."
                   class="bg-grey border-0 lh-32 pt-2 pb-2 ps-5 pe-3 font-xssss fw-500 rounded-xl w350 theme-dark-bg">
        </div>
    </form>
    <a href="{{route('home')}}" class="route p-2 text-center ms-3 menu-icon center-menu-icon"><i
            class="feather-home font-lg bg-greylight btn-round-lg theme-dark-bg text-grey-500"></i></a>
    <a href="#" class="route p-2 text-center ms-0 menu-icon center-menu-icon"><i
            class="feather-zap font-lg bg-greylight btn-round-lg theme-dark-bg text-grey-500"></i></a>
    <a href="#" class="route p-2 text-center ms-0 menu-icon center-menu-icon">
        <i class="feather-video font-lg bg-greylight btn-round-lg theme-dark-bg text-grey-500 "></i>
    </a>
    <a href="{{route('group')}}" class="route p-2 text-center ms-0 menu-icon center-menu-icon">
        <i class="feather-user font-lg bg-greylight text-grey-500 btn-round-lg theme-dark-bg text-current "></i>
    </a>
    <a href="#" class="route p-2 text-center ms-0 menu-icon center-menu-icon"><i
    ...
    <a href="{{route('settings')}}" class="p-0 ms-3 menu-icon"><img src="{{asset('images/profile-4.png')}}"
