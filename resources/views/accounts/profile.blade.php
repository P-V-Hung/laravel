                ...
                <div class="col-xl-8 col-xxl-9 col-lg-8">
                    <div class="card w-100 shadow-xss rounded-xxl border-0 ps-4 pt-4 pe-4 pb-3 mb-3 mt-3">
                        ...
                        <div class="card-body p-0 mt-3 position-relative">
                            <figure class="avatar position-absolute ms-2 mt-1 top-5"><img src="{{$user->image}}" alt="image"  style="height: 30px;object-fit: cover" class="shadow-sm rounded-circle w30"></figure>
                    ...
                    <div class="card w-100 shadow-xss rounded-xxl border-0 p-4 mb-3">
                        ...
                        <div class="card-body d-block p-0">
                            <div class="row ps-2 pe-2">
                                ...
                                <div class="col-xs-4 col-sm-4 p-1"><a href="images/t-11.jpg" data-lightbox="roadtrip"><img src="{{asset('images/t-11.jpg')}}" class="rounded-3 w-100" alt="image"></a></div>
                                <div class="col-xs-4 col-sm-4 p-1"><a href="images/t-12.jpg" data-lightbox="roadtrip" class="position-relative d-block"><img src="{{asset('images/t-12.jpg')}}" class="rounded-3 w-100" alt="image"><span class="img-count font-sm text-white ls-3 fw-600"><b>+2</b></span></a></div>
                            </div>
                        </div>
                    ...
                    <div class="card w-100 shadow-xss rounded-xxl border-0 p-4 mb-0">
                        <div class="card-body p-0 d-flex">
                            <figure class="avatar me-3"><img src="ima{{asset('ges/user-8.png')}}" alt="image" class="shadow-sm rounded-circle w45"></figure>
                    ...
                    <div class="card w-100 shadow-xss rounded-xxl border-0 p-4 mb-0">
                        ...
                        <div class="card-body d-block p-0 mb-3">
                            <div class="row ps-2 pe-2">
                                <div class="col-xs-6 col-sm-6 p-1"><a href="images/t-21.jpg" data-lightbox="roadtri"><img src="{{asset('images/t-21.jpg')}}" class="rounded-3 w-100" alt="image"></a></div>
                                <div class="col-xs-6 col-sm-6 p-1"><a href="images/t-22.jpg" data-lightbox="roadtri"><img src="{{asset('images/t-22.jpg')}}" class="rounded-3 w-100" alt="image"></a></div>
                            </div>
                            <div class="row ps-2 pe-2">
                                <div class="col-xs-4 col-sm-4 p-1"><a href="images/t-23.jpg" data-lightbox="roadtri"><img src="{{asset('images/t-23.jpg')}}" class="rounded-3 w-100" alt="image"></a></div>
                                <div class="col-xs-4 col-sm-4 p-1"><a href="images/t-24.jpg" data-lightbox="roadtri"><img src="{{asset('images/t-24.jpg')}}" class="rounded-3 w-100" alt="image"></a></div>
                                <div class="col-xs-4 col-sm-4 p-1"><a href="images/t-25.jpg" data-lightbox="roadtri" class="position-relative d-block"><img src="{{asset('images/t-25.jpg')}}" class="rounded-3 w-100" alt="image"><span class="img-count font-sm text-white ls-3 fw-600"><b>+2</b></span></a></div>
                            </div>
                        </div>
                        <div class="card-body d-flex p-0">
                            <a href="#" class="d-flex align-items-center fw-600 text-grey-900 text-dark lh-26 font-xssss me-3"><i class="feather-thumbs-up text-white bg-primary-gradiant me-1 btn-round-xs font-xss"></i> <i class="feather-heart text-white bg-red-gradiant me-2 btn-round-xs font-xss"></i>2.8K Like</a>
